#!/usr/bin/env python3
# LOGISTIA — Analyseur IA de securite
# Isolation Forest (scikit-learn) pour la detection d anomalies
...
def logistia_explain(anomaly):
    try:
        prompt = (
            f"Analyse de securite LOGISTIA en 2 phrases : "
...
def main():
    print(f"=== LOGISTIA IA — Analyse securite ===")
