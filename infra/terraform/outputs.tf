output "router_logistia_ip" {
  ...
  description = "router-logistia — NAT nftables WireGuard"
}

output "app_logistia_ip" {
  value       = module.app_logistia.ip
  description = "app-logistia — Nginx Dolibarr Traccar DMZ"
}

output "db_logistia_ip" {
  value       = module.db_logistia.ip
  description = "db-logistia — MariaDB VLAN Data isole"
}
...
output "backup_logistia_ip" {
  ...
  description = "backup-logistia — rsync 3-2-1"
}
